...
export default class RemoteVideo extends React.PureComponent {
  ...
  render() {
    ...
    return (
      <View>
        ...
        {this.state.loaded ? null : (
          <Animated.View pointerEvents="none" style={{
            ...
            <Image
              pointerEvents="none"
              resizeMode="contain"
              source={require('../../../assets/images/message/video.png')}
        ...
        >
          <Image source={require('../../../assets/images/message/play.png')} style={styles.playImg} />
        </TouchableOpacity>
      </View>
    )
  }
